...
templateUri="https://github.com/xuttah/azurerm/blob/master/azuredeploy.json"
parametersUri="https://github.com/xuttah/azurerm/blob/master/azuredeploy.parameters.json"
loc=westeurope
